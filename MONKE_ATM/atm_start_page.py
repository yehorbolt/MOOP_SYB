...
class StartPage(Frame):
    ...
    def __init__(self, master):
        ...
        Button(self, bg='#f7f0c6', activebackground='#f7f0c6', relief=FLAT, image=master.login_btn,
               width=170, height=50, command=lambda: master.switch_frame("ATMLoginPage")).pack(pady=5)
        ...
        Button(self, bg='#f7f0c6', activebackground='#f7f0c6', relief=FLAT, image=master.reg_btn,
               width=170, height=50, command=lambda: master.switch_frame("ATMRegistrationPage")).pack(pady=5)
        ...
        Label(self, text="", bg='#f7f0c6', image=master.who_is_it_this_is_monke).pack()
