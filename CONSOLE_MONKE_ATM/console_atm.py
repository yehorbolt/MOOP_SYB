...
class ATM:
    ...
    card_list = [["4149499378941895", False, True, 900, 250, 1000, 5, True, False],
        ...
        if randon_num == 2:
            for n in range(len(self.card_list)):
                if self.card_list[n][2]:
                    ...
                    if self.card_list[n][3] > self.card_list[n][6]:
    ...
    def __init__(self, login, amount):
        self.login = login
        self.amount = amount
        # cards from db and ...
    ...
    def card_menu(self, card_num):
        ...
        elif choose_card_menu == "7":
            atm.delete_card(card_num)
        else:
            print("Exit")
        atm.e_pocket()
    ...
    def withdraw(self, card_num):
        ...
        if self.card_list[card_num][2]:
            ...
            choose_amount = input("\nEnter a number: ")
            if choose_amount == "1":
                if 100 > self.card_list[card_num][5]:
                    print("You cant withdraw, sorry")
                else:
                    if self.card_list[card_num][3] < 100:
                ...
                if 500 > self.card_list[card_num][5]:
                    print("You cant withdraw, sorry")
                else:
                    if self.card_list[card_num][3] < 500:
                        print("You don`t have enough money on card")
                    else:
                        self.card_list[card_num][3] -= 500
                        self.amount += 100
                ...
                if int(how_amount) > self.card_list[card_num][5]:
                    print("You cant withdraw, sorry")
                else:
                    if self.card_list[card_num][3] < int(how_amount):
                        print("You don`t have enough money on card")
                    else:
                        self.card_list[card_num][3] -= int(how_amount)
                        self.amount += int(how_amount)
    ...
    def transfer(self, card_num):
        ...
        if self.card_list[card_num][2]:
            ...
            check_num = False
            for n in range(len(self.card_list)):
                if str(self.card_list[n][0]) == str(tr_card_num):
                    check_num = True
            if check_num:
                amount = input("How much you want to transfer: ")
                if int(amount) > self.card_list[card_num][3]:
                    ...
                    for n in range(len(self.card_list)):
                        if str(self.card_list[n][0]) == str(tr_card_num):
                            a = n
                    self.card_list[card_num][3] -= int(amount)
                    self.card_list[a][3] += int(amount)
                    ...
                    if want_to_print == "1":
                        ...
                        print("| Transferred to:   " + str(self.card_list[a][0]))
                        print("| Current balance on card: " + str(self.card_list[card_num][3]))
    ...
    # 7
    def delete_card(self, card_num):
        print("\n-----------------------MonkePal--------------------------")
        print("User " + self.login)
        print("Delete card")
        print("\nDo you want to delete your card? (Money will be lost)")
        print("1. Yes")
        print("2. No")
        print("an. Exit (like No :) )")

        del_card = input("Enter a number: ")
        if del_card == "1":
            self.card_list.pop(card_num - 1)
        elif del_card == "2":
            atm.card_menu(card_num)
        else:
            atm.card_menu(card_num)
